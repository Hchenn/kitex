...
// if it fails.
func NewServerTransport(ctx context.Context, conn netpoll.Connection, cfg *ServerConfig, handler func(s *Stream, tr ServerTransport, conn net.Conn)) (ServerTransport, error) {
	return newHTTP2Server(ctx, conn, cfg, handler)
}
